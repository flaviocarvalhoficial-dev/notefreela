                    ...
                    <header className="space-y-6">
                        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                            <div className="space-y-1">
                                ...
                                <p className="text-[12px] text-muted-foreground/60 font-medium lowercase tracking-widest">Dashboards & Business Insights</p>
                            </div>
                            ...
                            <div className="flex items-center gap-3 bg-muted/20 p-1.5 rounded-xl self-start">
                                <Button
                                    variant="ghost"
                                    size="sm"
                                    className="h-8 px-4 rounded-lg hover:bg-muted/30 hover:text-foreground transition-all text-[12px] font-medium gap-2"
                                ...
                                <Button
                                    size="sm"
                                    className="h-8 px-4 rounded-lg bg-primary text-primary-foreground gap-2 text-[12px] font-medium hover:shadow-glow-sm transition-all"
                            ...
                            {[
                                ...
                                <div key={i} className="bg-card/40 backdrop-blur-md p-5 rounded-2xl border-none shadow-card hover:bg-card/60 transition-all group overflow-hidden relative">
                                    <div className="flex items-start justify-between relative z-10">
                                        <div className="space-y-1">
                                            <p className="text-[11px] uppercase tracking-wider text-muted-foreground/60 font-bold">{card.label}</p>
                    ...
                    <div className="grid grid-cols-1 gap-10">
                        ...
                        <div className="flex flex-col h-[500px]">
                            <div className="flex items-center gap-2 px-1 mb-3">
                                ...
                                <h3 className="text-[11px] font-bold uppercase tracking-[0.15em] text-muted-foreground/60">Cronograma Operacional</h3>
                            </div>
                        ...
                        <div className="flex flex-col pb-10">
                            <div className="flex items-center gap-2 px-1 mb-3">
                                ...
                                <h3 className="text-[11px] font-bold uppercase tracking-[0.15em] text-muted-foreground/60">Radar de Oportunidades</h3>
                            </div>
                ...
                <div className="flex-1 overflow-y-auto custom-scrollbar p-6 space-y-8">
                    ...
                    <section className="space-y-3">
                        <div className="flex items-center gap-2 px-1">
                            ...
                            <h3 className="text-[11px] font-bold uppercase tracking-[0.15em] text-muted-foreground/60">Saúde do Negócio</h3>
                        </div>
                    ...
                    <section className="space-y-3">
                        <div className="flex items-center gap-2 px-1">
                            ...
                            <h3 className="text-[11px] font-bold uppercase tracking-[0.15em] text-muted-foreground/60">Notas Rápidas</h3>
                        </div>
                    ...
                    <div className="pt-6 border-t border-border/40">
                        <p className="text-[11px] text-muted-foreground/30 text-center uppercase tracking-[0.2em] font-medium">
